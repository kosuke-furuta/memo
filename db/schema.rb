...
ActiveRecord::Schema.define(version: 2021_02_26_202658) do
  ...
  create_table "taskmemos", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "created_at"], name: "index_taskmemos_on_user_id_and_created_at"
  ...
  add_foreign_key "taskmemos", "users"
end
